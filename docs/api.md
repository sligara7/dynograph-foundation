...
```json
{ "id": "my_graph", "wire_version": "0.13.0", "content_hash": "<sha256-hex>", "schema": {...} }
```
...
```json
{ "id": "my_graph", "wire_version": "0.13.0", "content_hash": "...", "schema": {...} }
```
...
version (e.g. `"0.13.0"`). Consumers compare it against a
