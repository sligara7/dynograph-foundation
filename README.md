...
Published images are tagged per release (`:0.9.0`) plus `:latest`.
...
Git dependency on the latest tag (`v0.9.0`):

```toml
[dependencies]
dynograph-core    = { git = "https://github.com/sligara7/dynograph-foundation.git", tag = "v0.9.0" }
dynograph-storage = { git = "https://github.com/sligara7/dynograph-foundation.git", tag = "v0.9.0" }
```
...
```toml
[dependencies]
dynograph-client = { git = "https://github.com/sligara7/dynograph-foundation.git", tag = "v0.9.0" }
```
