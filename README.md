...
docker run --rm -p 8080:8080 -v dynograph-data:/data \
    ...
    ghcr.io/sligara7/dynograph-foundation:0.6.3
...
Published images are tagged per release (`:0.6.3`) plus `:latest`.
...
Git dependency on the latest tag (`v0.6.3`):

```toml
[dependencies]
dynograph-core    = { git = "https://github.com/sligara7/dynograph-foundation.git", tag = "v0.6.3" }
dynograph-storage = { git = "https://github.com/sligara7/dynograph-foundation.git", tag = "v0.6.3" }
```
...
```toml
[dependencies]
dynograph-client = { git = "https://github.com/sligara7/dynograph-foundation.git", tag = "v0.6.3" }
```
